...
# File: numbertile                                                          #
# Description: A class for the tiles in the game board. Every location in   #
#   the game board has a pointer to an item from this class.                #
#############################################################################
*/
...
public:
    ...
    // Access value from outside the class
    int get_value();

    // Change value from outside the class
